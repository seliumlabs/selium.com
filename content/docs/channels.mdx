...
Channels are Selium's only I/O primitive. They are in-memory, many-to-many byte streams backed by a ring buffer and explicit backpressure rules.
...
Channels support strong and weak readers/writers:
...
Backpressure is a channel setting, configured on creation:
