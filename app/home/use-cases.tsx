...
const useCases = [
  ...
  },
  {
    ...
    description:
      "Replace brittle network glue with channel-native messaging between services.",
  ...
  },
  {
    ...
    description:
      "Process large data streams with backpressure and strict payload schemas.",
    icon: ChartBarIcon,
  ...
  },
  {
    ...
    description:
      "Embed orchestration into your app and scale function-level services on demand.",
    icon: CpuChipIcon,
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-300">
            Selium is a flexible fabric for typed, channel-native workloads. These are the first
            use cases we should highlight.
          </p>
        </div>
